...
void DisplayTools::lineTool(int size , char lineChar, bool returnLine){
...
void DisplayTools::barTool(float nominator , float denominator , int barLength , bool percentDisplay , bool returnLine){
...
void DisplayTools::promptTool(char prompt[500] , char result[500], char error[500], bool doError , bool isNumber){
